...
`;
const StyledTable = tw.table`bg-white table-auto border-collapse w-full`;
const StyledRow = tw.tr``;
const StyledCell = tw.td`p-4 text-sm`;
const StyledTHead = tw.thead`bg-white border-b border-b-zinc-200 text-sm`;
const StyledTBody = tw.tbody``;
const StyledHeaderRow = tw(StyledRow)``;
const StyledHeader = tw.th`p-4`;
